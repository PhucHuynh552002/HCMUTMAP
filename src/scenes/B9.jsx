...
import b9 from '../data/pic/B9/toa-b9.jpg';
import sa4 from '../data/pic/B9/b9.png';
const B9 = () => {
      ...
      <Box
        ...
        alignItems="center"
          ...
          <div class="main-map" style={{ textAlign: 'center', alignItems: 'center'}}>
            ...
            <Box>
              <img src={b9}  alt="A3" style={{width: "50%", height: "50%", marginLeft:"25%"}}/>
              </Box>
              <br></br>
              <Header title= "Sơ đồ B9"></Header>
              <Box>
